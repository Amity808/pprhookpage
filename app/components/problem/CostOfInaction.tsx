      ...
      <div className="max-w-[960px] mx-auto text-center">
        ...
        <div className="mt-16 flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            ...
            <button className="flex min-w-[200px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 border border-white/20 hover:bg-white/5 transition-all text-white text-base font-bold leading-normal tracking-[0.015em]">
              Schedule a Demo
            </button>
          </div>
        </div>
